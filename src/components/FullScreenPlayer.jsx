...
export default function FullScreenPlayer({
  ...
  return (
    ...
    >
      <div
        className="absolute inset-0 object-cover bg-center bg-cover blur-sm opacity-30"
        style={{ backgroundImage: `url(${current.image})` }}
      />

      <div className="absolute opacity-70 top-14 left-8 gap-4 text-white flex items-center">
        <Icon size={34} name="logo" />
        <div>
          <p className="text-sm">PLAYING FROM TRACK</p>
        </div>
      </div>
      ...
      <div
        ...
        className="w-full flex absolute bottom-4 flex-col px-8 items-center"
      >
        ...
        <div className="flex items-center absolute bottom-8  right-6 gap-x-3">
          <button
